...
제1장 총칙
제1조 (목적) 이 약관은 Jochana(이하 "회사"라 합니다)가 운영하는 위치기반 추억 공유 서비스 핀플 "애플리케이션"(이하 "APP"이라고 합니다)의 서비스 이용 및 제공에 관한 제반 사항의 규정을 목적으로 합니다.
제2조 (용어의 정의) ① 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
"서비스"라 함은 구현되는 PC, 모바일 기기를 통하여 "회사"가 "이용자"에게 제공하는 콘텐츠 및 전반적인 기능을 의미합니다.   
"회원"이란 "APP"에 회원등록을 한 자로서, "APP"이 제공하는 서비스를 이용하는 자를 말합니다.
"모바일 기기"란 콘텐츠를 다운로드 받거나 설치하여 사용할 수 있는 기기로서, 휴대폰, 스마트폰, 휴대정보단말기(PDA), 태블릿 등을 의미합니다.
"위치정보"란 회원이 위치 정보 수집 권한 동의를 통해 회사에게 제공한 위도 및 경도 등의 지리적 정보를 의미합니다.  
...
③ 회사가 약관을 개정할 경우에는 적용일자 및 개정내용, 개정사유 등을 명시하여 최소한 그 적용일 7일 이전부터 "APP" 내 또는 그 연결화면에 게시하여 이용자에게 공지합니다. 다만, 변경된 내용이 회원에게 불리하거나 중대한 사항의 변경인 경우에는 그 적용일 30일 이전까지 본문과 같은 방법으로 공지하고, 회원의 전자우편주소, 전자메모, 서비스 내 공지사항, 문자메시지(LMS/SMS)의 방법으로 회원에게 통지합니다. 이 경우 개정 전 내용과 개정 후 내용을 명확하게 비교하여 회원이 알기 쉽도록 표시합니다.
...
회원의 위치 정보에 기반한 맞춤형 콘텐츠 제공
회원의 위치 정보에 기반하여 콘텐츠 작성
콘텐츠 검색
기타 회사가 정하는 서비스
